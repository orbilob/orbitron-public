...
## Not a claim to have found an edge

The research engine is built specifically so it can return **"no edge"** — and that
answer is treated as a **success**, not a failure. An honest negative result saves
future time.
...
Large parts of what is described here are **designed, not built**. This vault
describes mechanisms in the present tense because that is how architecture reads —
but "described" is not "running".
...
This is the public subset. Infrastructure, network layout, hostnames, credentials,

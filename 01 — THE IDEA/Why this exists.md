...
```mermaid
flowchart LR
    Q["🔭 <b>the question</b><br/>why did the trend move this way,<br/>in this regime?"]
    OBS["📡 <b>observation</b><br/>prices · news · macro<br/>on-chain · sentiment"]
    ARCH["✍️ <b>we write the day down</b><br/>one day = one record, permanently<br/><i>a history that did not exist</i>"]
    TEST["🧪 <b>we test the answer</b><br/>against chance, over the whole record"]

...
<picture>
  ...
  <img src="assets/board-light.svg" alt="ORBITRON — state of the build: 41 working or proven, 14 partial, 2 not built, 9 decisions taken, 0 validated patterns" width="880">
</picture>

**41** working or proven &nbsp;·&nbsp; **14** partial &nbsp;·&nbsp; **2** not built &nbsp;·&nbsp; **9** decisions taken &nbsp;·&nbsp; **0** validated patterns

<sub>Generated from the project's live board on 2026-09-26 — not written by hand. The bar spans all 75 tracked rows; its unfilled tail is work that is deferred, archived or deliberately closed.</sub>
